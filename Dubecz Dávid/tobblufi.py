...
balloon_surf = pygame.image.load('Dubecz Dávid/img/balloon.png').convert_alpha()
balloons_rect = []
for _ in range(5):
...
bird_fw_1 = pygame.image.load('Dubecz Dávid/img/bird1.png').convert_alpha()
bird_fw_2 = pygame.image.load('Dubecz Dávid/img/bird2.png').convert_alpha()
bird_fw_3 = pygame.image.load('Dubecz Dávid/img/bird3.png').convert_alpha()
bird_fw_4 = pygame.image.load('Dubecz Dávid/img/bird4.png').convert_alpha()
birds_fw = [bird_fw_1, bird_fw_2, bird_fw_3, bird_fw_4]
bird_b_1 = pygame.image.load('Dubecz Dávid/img/bird1back.png').convert_alpha()
bird_b_2 = pygame.image.load('Dubecz Dávid/img/bird2back.png').convert_alpha()
bird_b_3 = pygame.image.load('Dubecz Dávid/img/bird3back.png').convert_alpha()
bird_b_4 = pygame.image.load('Dubecz Dávid/img/bird4back.png').convert_alpha()
