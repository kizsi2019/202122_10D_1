...
function calculate() {
  ...
  if (track === 'HUN' )
    ...
    document.getElementById('avaragespeed'). value = (3.337 / laptime).toString + km/h;
    else if (track === 'BEL')
    document.getElementById('avaragespeed'). value = (7.004 / laptime).toString + km/h;
    else if (track === 'ITA')
    document.getElementById('avaragespeed'). value = (5.793 / laptime).toString + km/h;
    else
